...
private struct SleepDebtDetailView: View {
    ...
    var body: some View {
        ScreenScaffold(title: "Sleep Debt", subtitle: "A bounded NOOP estimate from your sleep history.", lazy: true) {
            if let latest {
                NoopCard(tint: StrandPalette.statusWarning) {
                    VStack(alignment: .leading, spacing: NoopMetrics.space3) {
                        ...
                        Text("Carried debt decays each night and is capped at four hours. It is an estimate, not a diagnosis or a proprietary WHOOP value.")
                ...
                if plotted.count >= 2 {
                    ChartCard(title: "Recent carried debt", trailing: duration(latest.carriedDebtMinutes ?? 0),
                              ...
                              chart: {
                        RoundedBarTrendChart(points: Array(plotted.suffix(30)), valueRange: 0...240,
